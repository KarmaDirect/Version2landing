...
export function HeroSection() {
  return (
                   <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-white via-gray-50 to-gray-100 relative overflow-hidden pb-20">
      ...
      <div className="container mx-auto px-4 text-center text-gray-800 z-10">
            ...
            <div className="relative inline-block ml-2">
             ...
             >
               ...
               />
                           ...
                           <p className="text-xl md:text-2xl mb-8 max-w-5xl mx-auto text-gray-600 leading-relaxed">
            ...
            .{" "}
             <AuroraText 
               ...
               speed={1.5}
             >
               Gagnez du temps, réduisez les coûts, maximisez votre ROI.
             </AuroraText>
          </p>
        ...
        <div className="mb-8 mt-12">
          ...
          <div className="flex items-center justify-center gap-6 mb-8">
            ...
            <ShimmerButton 
              className="text-lg font-bold py-4 px-8 shadow-lg w-full sm:w-auto !text-white"
              shimmerColor="#ffffff"
            ...
            >
              Prendre RDV Gratuit
                               ...
                               {/* Velocity Scroll - partie intégrante de la hero section */}
         <div className="absolute bottom-16 left-0 right-0 z-20">
          ...
          >
            <AuroraText 
              ...
              speed={1.5}
            >
              Made in Amiens • Rentabilité • Automatisation • Fiabilité • Webstate • Solutions clés-en-main • Devis Rapide • 
            </AuroraText>
          </VelocityScroll>
        </div>
